...
CSF::createOptions( $prefix, array(
  'menu_title' => 'Braintech',
  'menu_slug'  => 'braintech-demo',
) );
...
CSF::createSection($prefix , array(
  'title'   =>  esc_html__( 'Top Bar', 'braintech'),
  'id'      =>  'top-bar',
  'icon'    =>  'fa fa-ravelry',
  'parent' =>  'header',
  'fields'  =>  array(
    ...
    array(
      'title' =>  esc_html__( 'Logo upload', 'braintech' ),
      'id'    =>  'logo-upload',
      'type'  =>  'upload',
    ...
    array(
      'title' =>  esc_html__( 'Mobile Logo upload', 'braintech' ),
      'id'    =>  'mobile-upload',
      'type'  =>  'upload',
    ...
    array(
      'title' =>  esc_html__( 'Sticky Logo upload', 'braintech' ),
      'id'    =>  'sticky-upload',
      'type'  =>  'upload',
      'default' =>  get_template_directory_uri().'/assets/images/logo-dark.png'
    ),
    ...
    array(
      ...
      'id'    =>  'address',
      'type'  =>  'text',
      'default' =>  '5 kandi BR. New York',
    ),

    array(
      'title'   =>  esc_html__( 'Email', 'braintech'),
      'id'      =>  'email',
      'type'    =>  'text',
      'default' =>  'support@rstheme.com',
    ),
...
array(
							...
							'desc'       => '<small>Default icon: fa-brands fa-pinterest</small>',
							'dependency' =>array( 'fa-pinterest-switcher', '==', 'true' ),
						),
array(
							'id'         => 'fa-pinterest-url',
							'type'       => 'text',
							...
							'desc'       => '<small>Default Url: https://www.pinterest.com/#</small>',
							'dependency' =>array( 'fa-pinterest-switcher', '==', 'true' ),
						),
					)
				),
...
CSF::createSection($prefix , array(
  'parent'  =>  'header',
  'title'   =>  esc_html__('Blog Header', 'braintech' ),
  ...
  'fields'  =>   array(
    ...
    array(
        ...
        'type'      =>  'text',
        'default'   =>  'Blog',
        'desc'      =>  '<small>You can add Blog Page Title</small>'
    ),
    ...
    array(
      ...
      'text_width' => 100,
      'default'    => true,
      'desc'       => '<small>Breadcrumb Title Show or Hide</small>'
    ),
  ),
));
...
CSF::createSection($prefix , array(
  ...
  'fields'    =>   array(
    ...
    array(
      'title'   => esc_html__('Copyright', 'braintech' ),
      'id'      =>  'copyright',
      'type'    =>  'text',
      'default' =>  '&copy; 2021 All Rights Reserved. Developed By',
    ),

    array(
      'title'   => esc_html__('Author', 'braintech' ),
      'id'      =>  'author',
      'type'    =>  'text',
      'default' =>  'RSTheme',
      'desc'    =>  '<small>You can add author name</small>',
    ),

    array(
      'title'   => esc_html__('Author URL', 'braintech' ),
      'id'      =>  'author-url',
      'type'    =>  'text',
      'default' =>  'http://rstheme.com/',
      'desc'    =>  '<small>You can add author url</small>',
    ),
